...
<form action="/user/created" id="table8">
			<table >
				<tr><th>Welcome to Axis Salary Account</th></tr>
				...
				<tr><td><input type="text" name="ucompanyid" placeholder="Enter Company id"></td></tr>
				<tr><td><input type="password" name="upassword" placeholder="Create Password"></td></tr>
				<tr><td><input type="text" name="uaccounttype" value="Salary" readonly="readonly"></td></tr>
				<tr><td><input type="number" name="ubalance"   value=0	readonly="readonly">(minimum balance should be Zero)</td></tr>
